...
def run():
    ...
    model = DetectMultiBackend(weights=r'D:\Code\yolov5final\weights\yolov5n.pt', device=device, dnn=False, data=False, fp16=True)
    ...
    while True:
        ...
        #非極大值抑制
        pred = non_max_suppression(pred, conf_thres=0.6, iou_thres=0.45, classes=1, max_det=1000)
